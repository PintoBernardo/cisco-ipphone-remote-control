...
class Cisco7945Phone(CiscoBasePhone):
    ...
    def build_ui(self):
        ...
        tk.Button(vf, text="MUTE", width=14, bg="#c0392b", fg="white", relief="flat", 
                  font=("Segoe UI", 8, "bold"), activebackground="#a93226",
        ...
        tk.Button(v_sub, text="VOL +", width=6, bg="#555", fg="white", relief="flat", 
                  font=("Segoe UI", 8), activebackground="#666",
                  command=lambda: self.press(ak.get('VOL_UP'))).pack(side="left", padx=1)
        tk.Button(v_sub, text="VOL -", width=6, bg="#555", fg="white", relief="flat", 
                  font=("Segoe UI", 8), activebackground="#666",
                  command=lambda: self.press(ak.get('VOL_DOWN'))).pack(side="left", padx=1)
